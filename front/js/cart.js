...
.then(function(data)
{    
    // Tri les élements, grace à la fonction prend 2 produits les compare et les replace par rapport à leur id dans le tableaux et recommence jusqu'à tout les id soient triés..
    cart.sort(function triProducts(a, b) 
    {
    ...
    function unlockSubmit(testFirstName, testLastName, testAddress, testCity, testEmail) 
    {
...
//Affiche les produits avec leur détails;
...
function total(cart, i, totalPriceByProduct) 
{
...
function recalculateTotal(indice, modifiedPriceProduct, find) 
{
